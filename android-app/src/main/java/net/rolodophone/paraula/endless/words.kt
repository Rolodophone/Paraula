...
/**
 * A representation of a single meaning of a word, in Catalan and English. Words that could be considered synonymous but actually mean slightly different things e.g. run and sprint should be in separate objects. Expressions e.g. "the time is" should be of the Expression subclass.
 */
...
@TypeLabel("NOUN")
@JsonClass(generateAdapter = true)
class Noun(override val catalan: List<String>, override val english: List<String>, val gender: Gender): Word()

@TypeLabel("VERB")
@JsonClass(generateAdapter = true)
class Verb(override val catalan: List<String>, override val english: List<String>): Word()

@TypeLabel("STRONG_PRONOUN")
@JsonClass(generateAdapter = true)
class StrongPronoun(override val catalan: List<String>, override val english: List<String>, val person: Person, val number: Number, val gender: Gender?, val formality: Formality?): Word()